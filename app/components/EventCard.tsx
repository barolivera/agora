...
export function EventCard({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative w-full shrink-0 flex flex-col items-end p-3"
      ...
      {/* Bottom info strip — light */}
      <div className="bg-[#fafafa] border-t border-[rgba(128,128,128,0.2)] h-[142px] shrink-0 px-5 flex items-center">
        <div className="flex flex-col gap-3 flex-1 min-w-0">
          ...
          {/* Title */}
          <p className="text-xl font-bold leading-[1.1] text-[#191919] font-[family-name:var(--font-kode-mono)] truncate">
            {event?.title || 'Untitled Event'}
          </p>

          {/* Date */}
          {formattedDate && (
            <p className="text-[14px] font-semibold leading-4 text-[#191919] font-[family-name:var(--font-geist-sans)] truncate">
              {formattedDate}
            </p>
          )}
...
export function CardSkeleton({ index }: { index: number }) {
  return (
    <div className="flex flex-col overflow-clip">
      ...
      />
      <div className="bg-[#fafafa] h-[142px] shrink-0 animate-pulse border-t border-[rgba(128,128,128,0.2)]" style={{ opacity: 0.5 }} />
    </div>
  );
}
